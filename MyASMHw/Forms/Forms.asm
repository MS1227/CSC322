...
PrintCount          BYTE      01								;;Integer value initialized to 1 for use in marking line numbers when printing out records
counter             BYTE      00								;;Integer value initialized to 0 for use in counting number of inserted records
